...
fun main() {
    ...
    val result =
        if ((userNumberOne == NUMBER_ONE && userNumberTwo == NUMBER_TWO) || (userNumberOne == NUMBER_TWO && userNumberTwo == NUMBER_ONE))
            "Поздравляем вы выйграли главный приз!"
        else if ((userNumberOne == NUMBER_TWO || userNumberTwo == NUMBER_ONE) || (userNumberOne == NUMBER_ONE || userNumberTwo == NUMBER_TWO))
